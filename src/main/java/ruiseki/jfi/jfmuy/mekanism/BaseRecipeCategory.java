...
public abstract class BaseRecipeCategory<WRAPPER extends IRecipeWrapper>
    implements IRecipeCategory<WRAPPER>, IGuiWrapper {
    ...
    protected void initGas(IGuiIngredientGroup<GasStack> group, int slot, boolean input, int x, int y, int width,
        ...
        GasStackRenderer renderer = new GasStackRenderer(
            stack.amount,
            false,
            width,
            height,
